...
function Admin() {
    ...
    useEffect(() => {
        axios.get("http://localhost:8080/attendance/showAll").then((data) => {
    ...
    const handleDelOk = () => {
        axios
            .delete("http://localhost:8080/attendance/deleteAsssosiate/" + delAsso)
    ...
    const handleUpdateOk = () => {
        ...
        axios
            .put(
                "http://localhost:8080/attendance/updateAssociate/" + data.associate_id,
                {
            ...
            >
                ...
                >
                    ...
                    <Form.Item label="Base Location">
                        <Input
                            type="text"
                            placeholder="Enter the base location"
                            name="base_location"
                            onChange={handleChange}
                        />
                    </Form.Item>
